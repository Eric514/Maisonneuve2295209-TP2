...
<div class="container">
  <div class="row justify-content-center display-flex-center">
    <div class="col-lg-8">
      ...
      <div class="card">
        <div class="card-header">@lang('lang.your_forum_posts') :</div> <br />
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">@lang('lang.your_file_uploads') :</div> <br />
        <div class="card-body">
          @if(Auth::user()->userHasFilePost != null && count(Auth::user()->userHasFilePost) > 0)
          <div class="table-responsive">
            <table class="table table-bordered">
              <thead>
                <tr>
              ...
              <tbody>
                @foreach(Auth::user()->userHasFilePost as $filePost)
                <tr>
                  <td>{{ app()->getLocale() === 'fr' ? $filePost->title_fr : $filePost->title_en }}</td>
                  <td>{{ $filePost->created_at }}</td>
                  <td>
                    <div class="display-inline-flex">
                      <a href="{{ asset('files/'.$filePost->filename) }}" target="_blank" class="btn btn-info">@lang('lang.download')</a>
                      <a href="{{ route('files.edit', $filePost->id) }}" class="btn btn-warning">@lang('lang.edit')</a>
